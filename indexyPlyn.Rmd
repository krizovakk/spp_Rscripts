...
append_to_excel(dawemo, paste0(path_in, "indexyPlyn_20250601.xlsx"), sheet = "ICIS")
```
...
append_to_excel(icis, paste0(path_in, "indexyPlyn_20250601.xlsx"), sheet = "ICIS komplet")
```
...
append_to_excel(eex, paste0(path_in, "indexyPlyn_20250601.xlsx"), sheet = "EEX")
