...
# PO
# pub_d <- as.Date("18.7.2025", format = "%d.%m.%Y") # zadej patek
...
df <- data.frame(
  `Publication date` = pub_d,
  value1 = 35.580, # VTP Cal+1
  value2 = 36.374, # VTP Q+1
  value3 = 34.715, # VTP M+1
  value4 = 34.306	, # THE Cal+1
  value5 = 35.322	, # THE Q+1
  value6 = 33.642, # THE M+1
  value7 = 33.085, # TTF Cal+1
  value8 = 34.110, # TTF Q+1
  value9 = 32.378	  # TTF M+1
)
