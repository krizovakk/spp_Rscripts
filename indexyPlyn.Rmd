...
append_to_excel(dawemo, paste0(path_out, "indexyPlyn_20250601.xlsx"), sheet = "ICIS")
```
...
append_to_excel(icis, paste0(path_out, "indexyPlyn_20250601.xlsx"), sheet = "ICIS komplet")
```
...
pub_d <- as.Date("27.6.2025", format = "%d.%m.%Y")
...
nelze automatizovat (prilis mnoho klikani pro volbe trhu a produktu)
vyplnuejme jen 99999, nutno prepsat rucne v excelu
...
append_to_excel(eex, paste0(path_out, "indexyPlyn_20250601.xlsx"), sheet = "EEX")
...
# file.copy(from = paste0(path_out, "indexyPlyn_20250601.xlsx"),
#           to = path_bu,
#           overwrite = TRUE)
...
# file.copy(from = paste0(path_out, "indexyPlyn_20250601.xlsx"),
#           to = "X:/Nakup _ NEW/Indexy_Plyn/indexyPlyn_20250601.xlsx",
#           overwrite = TRUE)
