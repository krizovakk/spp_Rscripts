...
# PO
# pub_d <- as.Date("26.9.2025", format = "%d.%m.%Y") # zadej patek
...
df <- data.frame(
  `Publication date` = pub_d,
  value1 = 33.336	, # VTP Cal+1
  value2 = 33.831	, # VTP Q+1
  value3 = 33.593, # VTP M+1
  value4 = 32.408	, # THE Cal+1
  value5 = 33.026, # THE Q+1
  value6 = 32.784		, # THE M+1
  value7 = 31.112, # TTF Cal+1
  value8 = 32.011, # TTF Q+1
  value9 = 32.102			 # TTF M+1
)
