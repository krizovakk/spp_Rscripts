...
# PO
pub_d <- as.Date("10.10.2025", format = "%d.%m.%Y") # zadej patek nebo jiny den zpetne
...
df <- data.frame(
  ...
  value1 = 33.726, # VTP Cal+1
  value2 = 34.343, # VTP Q+1
  value3 = 33.740, # VTP M+1
  value4 = 32.637, # THE Cal+1
  value5 = 33.597, # THE Q+1
  value6 = 33.144, # THE M+1
  value7 = 31.363, # TTF Cal+1
  value8 = 32.509, # TTF Q+1
  value9 = 32.175	 # TTF M+1
)
