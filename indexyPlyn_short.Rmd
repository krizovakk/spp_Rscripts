...
# PO
# pub_d <- as.Date("5.9.2025", format = "%d.%m.%Y") # zadej patek
...
df <- data.frame(
  `Publication date` = pub_d,
  value1 = 34.663	, # VTP Cal+1
  value2 = 35.497	, # VTP Q+1
  value3 = 34.927	, # VTP M+1
  value4 = 33.645	, # THE Cal+1
  value5 = 34.489, # THE Q+1
  value6 = 33.816, # THE M+1
  value7 = 32.384,	 # TTF Cal+1
  value8 = 33.470, # TTF Q+1
  value9 = 32.910			  # TTF M+1
)
...
g_mid <- ggplot(mid, aes(x = Date, y = value, color = series)) + 
  ...
  scale_fill_manual(values = c(
      ...
      "THE" = "olivedrab",
      "CZ-VTP" = "lightseagreen"))+
  labs(x = "", y = "€ / MWh", title = "Natural Gas Prices", colour = "", fill = "") +
  scale_x_date(
