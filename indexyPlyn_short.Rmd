...
# PO
pub_d <- as.Date("3.10.2025", format = "%d.%m.%Y") # zadej patek nebo jiny den zpetne
...
df <- data.frame(
  ...
  value1 = 33.280	, # VTP Cal+1
  value2 = 33.790,	 # VTP Q+1
  value3 = 33.099, # VTP M+1
  value4 = 32.330, # THE Cal+1
  value5 = 32.999, # THE Q+1
  value6 = 32.326, # THE M+1
  value7 = 31.056, # TTF Cal+1
  value8 = 31.969, # TTF Q+1
  value9 = 31.440			 # TTF M+1
)
...
mid <- date %>% 
  select("Date" = `Delivery date`, "TTF" = `(d) TTF Mid`, "THE" = `(d) THE Mid`, "CZ-VTP" = `(d) CZ-VTP Mid`) %>% 
...
g_mid <- ggplot(mid, aes(x = Date, y = value, color = series)) + 
  ...
  scale_fill_manual(values = c(
      ...
      "CZ-VTP" = "deepskyblue3"))+
      # "CZ-VTP" = "lightseagreen"))+
  labs(x = "", y = "€ / MWh", title = "Natural Gas Prices :: Day-Ahead", colour = "", fill = "") +
  scale_x_date(
