...
```{r}
icis <- cons %>% 
  mutate(`TTF - THE` = `TTF Mid`-`THE Mid`,
         `TTF - CZ-VTP` = `TTF Mid`-`CZ-VTP Mid`,
         `THE - CZ-VTP` = `THE Mid`-`CZ-VTP Mid`,
...
wb <- loadWorkbook(paste0(path_out, "ICISHeren_harvestedReports_DA_WE_MA.xlsx"))
